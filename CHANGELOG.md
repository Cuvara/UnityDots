...
- StressBenchmark asmdef: Unity.Physics moved to optional versionDefine
- Removed ProductionHardening sample (API mismatches in CI)
- PooledViewAssetProvider: EditMode-safe DestroyImmediate
- ArchetypeFactory: correct LocalToWorld + TimeToLive field names
